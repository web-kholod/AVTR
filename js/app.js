(() => {
    ...
    (() => {
        ...
        $(".slider").slick({
            ...
            variableWidth: true,
            centerMode: true,
            prevArrow: '<button type="button" class="slider__arrow slider__arrow-left icon-arrow-left"></button>',
            nextArrow: '<button type="button" class="slider__arrow slider__arrow-right icon-arrow-right"></button>'
        });
